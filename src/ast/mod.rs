...
use oxc_ast::{ast::Program, AstBuilder as OxcAstBuilder};
...
impl<'a> AstBuilder<'a> {
    ...
    pub fn build_from_cfg(&mut self, _cfg: &Cfg) -> Program {
        ...
        let program = self
            .builder
            .program(span, source_type, "", comments, None, directives, body);
    ...
    pub fn create_binary_expression(&mut self, left: &str, operator: &str, right: &str) -> String {
    ...
    pub fn create_variable_declaration(&mut self, name: &str, init: Option<&str>) -> String {
        match init {
