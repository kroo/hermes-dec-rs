...
fn test_jump_table_basic_functionality() {
    ...
    let instructions = vec![
        ...
        HbcFunctionInstruction { 
            ...
            function_index: 0,
            instruction_index: 1,
            instruction: UnifiedInstruction::LoadConstUInt8 { operand_0: 1, operand_1: 42 },
        },
        HbcFunctionInstruction { 
            offset: 4,
            function_index: 0,
            instruction_index: 2,
            instruction: UnifiedInstruction::LoadConstUInt8 { operand_0: 2, operand_1: 100 },
        },
        HbcFunctionInstruction { 
            offset: 6,
            function_index: 0,
            instruction_index: 3,
            instruction: UnifiedInstruction::JmpFalse { operand_0: -4, operand_1: 4 }, // Jump to instruction index 1
        },
        HbcFunctionInstruction { 
            offset: 8,
            function_index: 0,
